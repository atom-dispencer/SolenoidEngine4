...
//1162654/1506577/2.50/17/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MA730GQ-Z" (originalName "MA730GQ-Z")
	...
	(compDef "MA730GQ-Z" (originalName "MA730GQ-Z") (compHeader (numPins 17) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "14" (pinName "N/C") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "13" (pinName "VDD") (partNum 1) (symPinNum 17) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MA730GQ-Z"))
		...
		(attr "Mouser Part Number" "946-MA730GQ-Z")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Monolithic-Power-Systems-MPS/MA730GQ-Z?qs=YCa%2FAAYMW01z3klrRj76PA%3D%3D")
		(attr "Manufacturer_Name" "Monolithic Power Systems (MPS)")
		(attr "Manufacturer_Part_Number" "MA730GQ-Z")
		(attr "Description" "Board Mount Hall Effect / Magnetic Sensors 14-bit, digital, contactless angle sensor with ABZ incremental and PWM output")
		(attr "<Hyperlink>" "https://www.monolithicpower.com/pub/media/document/m/a/ma730_r1.01.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "MA730GQ-Z.stp")
