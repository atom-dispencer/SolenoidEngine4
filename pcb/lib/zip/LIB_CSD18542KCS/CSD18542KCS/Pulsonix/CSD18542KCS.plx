...
//723869/1506577/2.50/3/3/MOSFET N-Channel
...
(library Library_1
	...
	(patternDef "TO254P470X1016X2016-3P" (originalName "TO254P470X1016X2016-3P")
		(multiLayer
		...
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 8.125 3.475) (pt 8.125 -1.725) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 8.125 -1.725) (pt -3.045 -1.725) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -3.045 -1.725) (pt -3.045 3.475) (width 0.05))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.795 3.225) (pt 7.875 3.225) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.875 3.225) (pt 7.875 -1.475) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.875 -1.475) (pt -2.795 -1.475) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.795 -1.475) (pt -2.795 3.225) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.795 1.955) (pt -1.525 3.225) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt 7.875 -1.475) (pt 7.875 3.225) (width 0.2))
		)
		(layerContents (layerNumRef 18)
	...
	(symbolDef "CSD18542KCS" (originalName "CSD18542KCS")
	...
	(compDef "CSD18542KCS" (originalName "CSD18542KCS") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "CSD18542KCS"))
		(attachedPattern (patternNum 1) (patternName "TO254P470X1016X2016-3P")
			(numPads 3)
			(padPinMap
		...
		(attr "Mouser Part Number" "595-CSD18542KCS")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/CSD18542KCS?qs=sICFeol8QWE7Rbjncdrc5g%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "CSD18542KCS")
		(attr "Description" "CSD18542KCS 60-V N-Channel NexFET&#153; Power MOSFET")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/csd18542kcs")
		(attr "<Component Height>" "4.7")
		(attr "<STEP Filename>" "CSD18542KCS.stp")
		(attr "<STEP Offsets>" "X=2.54;Y=3.16;Z=0.78")
