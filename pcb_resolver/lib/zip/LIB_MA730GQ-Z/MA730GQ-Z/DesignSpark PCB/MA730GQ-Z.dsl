...
(library Library_1
	...
	(compDef "MA730GQ-Z" (originalName "MA730GQ-Z") (compHeader (numPins 17) (numParts 1) (refDesPrefix IC)
		...
		(compPin "14" (pinName "N/C") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.monolithicpower.com/pub/media/document/m/a/ma730_r1.01.pdf")
		(attr "Height" "1 mm")
	)
